...
//
//	int16_t mag_x, mag_y, mag_z;
//	mag_x = mraa_mpu_i2c_read_byte_data(i2c_context, 0x03) |
//			mraa_mpu_i2c_read_byte_data(i2c_context, 0x04) << 8;
//	mag_y = mraa_mpu_i2c_read_byte_data(i2c_context, 0x05) |
//			mraa_mpu_i2c_read_byte_data(i2c_context, 0x06) << 8;
//	mag_z = mraa_mpu_i2c_read_byte_data(i2c_context, 0x07) |
//			mraa_mpu_i2c_read_byte_data(i2c_context, 0x08) << 8;
//
////	printf("%d %d %d\n", mag_x, mag_y, mag_z);
//
//
...
void mpu_run(void) {
	...
	int16_t acc_x, acc_y, acc_z;
	acc_x = mraa_mpu_i2c_read_byte_data(i2c_context, 0x3B) << 8 |
			mraa_mpu_i2c_read_byte_data(i2c_context, 0x3C);
	acc_y = mraa_mpu_i2c_read_byte_data(i2c_context, 0x3D) << 8 |
			mraa_mpu_i2c_read_byte_data(i2c_context, 0x3E);
	acc_z = mraa_mpu_i2c_read_byte_data(i2c_context, 0x3F) << 8 |
			mraa_mpu_i2c_read_byte_data(i2c_context, 0x40);
...
//	printf("%d %d %d\n", acc_x, acc_y, acc_z);
	...
	int16_t gyr_x, gyr_y, gyr_z;
	gyr_x = mraa_mpu_i2c_read_byte_data(i2c_context, 0x43) << 8 |
			mraa_mpu_i2c_read_byte_data(i2c_context, 0x44);
	gyr_y = mraa_mpu_i2c_read_byte_data(i2c_context, 0x45) << 8 |
			mraa_mpu_i2c_read_byte_data(i2c_context, 0x46);
	gyr_z = mraa_mpu_i2c_read_byte_data(i2c_context, 0x47) << 8 |
			mraa_mpu_i2c_read_byte_data(i2c_context, 0x48);
